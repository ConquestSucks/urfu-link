...
namespace NotificationService.Api.Migrations
{
    ...
    [Migration("20260525171547_AddNotificationSourceActionKeyDedupe")]
    partial class AddNotificationSourceActionKeyDedupe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Urfu.Link.Services.Notification.Domain.Aggregates.Notification", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LastOccurrenceAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_occurrence_at_utc");
            ...
            modelBuilder.Entity("Urfu.Link.Services.Notification.Domain.Aggregates.NotificationDedupKey", b =>
                {
                    b.Property<Guid>("RecipientUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("recipient_user_id");
                    ...
                    b.HasKey("RecipientUserId", "SourceEventId", "NotificationType");
