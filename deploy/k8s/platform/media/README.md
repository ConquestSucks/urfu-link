...
WebRTC ports (`7881/tcp`, `3478/udp`, `5349/tcp`, `50000-50100/udp`) and the
embedded TURN relay range (`50101-50200/udp`) are bound by `livekit-server`
itself. Its Deployment uses `Recreate` because two
