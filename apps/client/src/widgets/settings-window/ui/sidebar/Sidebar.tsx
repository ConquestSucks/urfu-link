...
export const Sidebar = ({ activeTab, onTabChange, onClose }: SidebarProps) => {
    ...
    return (<View className="bg-[#080D1D] h-full flex-col border-r border-white/10 p-6 gap-2 w-[calc(256/896*100%)]">
      ...
      <View className="border-t border-white/5 pt-6">
        <ProfileCard userName={userName} userDescription={userDescription} avatarUrl={avatarUrl} avatarSize={40}/>
      </View>
    </View>);
};
