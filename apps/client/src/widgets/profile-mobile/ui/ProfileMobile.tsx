...
import { AtIcon, BellIcon, CaretRightIcon, EnvelopeSimpleIcon, MonitorIcon, ShieldCheckIcon, SignOutIcon, SpeakerHighIcon, } from "phosphor-react-native";
...
export const ProfileMobile = () => {
    ...
    return (<ScrollView className="flex-1 bg-[#080D1D]" contentContainerStyle={{ paddingBottom: 24 + MOBILE_TAB_BAR_HEIGHT }}>
      <View className="items-center pt-8 pb-6">
        <View className="relative">
          <Avatar src={avatarUrl} size={100} className="rounded-full"/>
          <StatusIndicator status="online" size={24} className="border-4 border-[#080D1D] bottom-1 right-1"/>
        </View>
