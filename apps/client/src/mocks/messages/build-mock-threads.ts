...
/** Ленивая инициализация, чтобы не дублировать списки id в двух местах */
let cache: Record<string, ChatMessageProps[]> | null = null;

export function getMockMessagesByThread(): Readonly<
  Record<string, readonly ChatMessageProps[]>
> {
  if (!cache) {
...
export function getMockMessagesForThread(
  threadKey: string,
